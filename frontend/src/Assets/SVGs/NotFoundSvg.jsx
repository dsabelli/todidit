...
const NotFoundSvg = ({ className }) => {
  return (
    <div className={`text-primary ${className}`}>
      ...
      >
        <path
          id="aabd4afe-642c-4327-a3f2-08ec89276309-225"
          data-name="Path 482"
        ...
        />
        <path
          id="e302a207-98de-4798-aedc-79a63cff2427-226"
          data-name="Path 483"
        ...
        />
        <path
          id="e16a8a0b-115e-4877-a9d6-27a72cf85b73-227"
          data-name="Path 482"
        ...
        />
        <path
          id="b0706b48-08e0-43ea-ab25-36cfaee90c12-228"
          data-name="Path 483"
