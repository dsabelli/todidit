    ...
    <div className="py-8 px-16 mx-auto">
      ...
      <Section>
        ...
        <P>
          ...
          support@todidit.com so we can try to find a solution. These Terms
          apply to all visitors, users and others who wish to access or use
          Service.
        </P>
        <P className="pl-6">Thank you for being responsible.</P>
      </Section>
      <Section>
        <HTwo>
      ...
      <Section>
        <HTwo>
          3. <span className="underline">Refunds</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          4. <span className="underline">Content</span>
        </HTwo>
        <P>
        ...
        <P>
          todidit.com has the right but not the obligation to monitor and edit
          all Content provided by users.
        </P>
      </Section>
      <Section>
        <HTwo>
          5. <span className="underline">Prohibited Uses</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          6. <span className="underline">Analytics</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          7. <span className="underline">No Use By Minors</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          8. <span className="underline">Accounts</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          9. <span className="underline">Intellectual Property</span>
        </HTwo>
        <P>
          Service and its original content (excluding Content provided by
          users), features and functionality are and will remain the exclusive
          property of todidit.com and its licensors. Service is protected by
          ...
          product or service without the prior written consent of todidit.com.
        </P>
      </Section>
      <Section>
        <HTwo>
          10. <span className="underline">Error Reporting and Feedback</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          11. <span className="underline">Links To Other Web Sites</span>
        </HTwo>
        <P>
          Our Service may contain links to third party web sites or services
          that are not owned or controlled by todidit.com.
        </P>
        <P>
          todidit.com has no control over, and assumes no responsibility for the
        ...
        <P>
          YOU ACKNOWLEDGE AND AGREE THAT todidit.com SHALL NOT BE RESPONSIBLE OR
      ...
      <Section>
        <HTwo>
          12. <span className="underline">Disclaimer Of Warranty</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          13. <span className="underline">Limitation Of Liability</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          14. <span className="underline">Termination</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          15. <span className="underline">Governing Law</span>
        </HTwo>
        <P>
          These Terms shall be governed and construed in accordance with the
          laws of Province of Ontario without regard to its conflict of law
          provisions.
        </P>
        <P>
      ...
      <Section>
        <HTwo>
          16. <span className="underline">Changes To Service</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          17. <span className="underline">Amendments To Terms</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          18. <span className="underline">Waiver And Severability</span>
        </HTwo>
        <P>
      ...
      <Section>
        <HTwo>
          19. <span className="underline">Acknowledgement</span>
        </HTwo>
        <P>
