    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to toDidit.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to toDidit, accessible from{" "}
            <a
              href="https://www.todidit.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.todidit.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.todidit.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.todidit.com/contact
          </a>
        </li>
      </ul>
    </div>
